...
class FacadeDelegationTests(unittest.TestCase):
    def test_course_facade_delegates_resource_and_service_operations(self):
        ...
        facade.create(data={"courseId": "C"}); facade.update(course_identifier="C", data={})
    ...
    def test_user_node_term_and_role_facades_delegate_all_public_operations(self):
        ...
        users.list(); users.iter(); users.get(user_identifier="U"); users.create(data={})
        ...
        nodes.list(); nodes.iter(); nodes.get(node_identifier="N"); nodes.create(data={})
        ...
        terms.list(); terms.iter(); terms.get(term_identifier="T"); terms.create(data={})
